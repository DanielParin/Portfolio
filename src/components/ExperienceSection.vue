<template>
    <section class="text-white mt-18 relative overflow-hidden" id="skills">
  ...
  const Skills = ref([
    { id: 1, name: 'Java', width: '85%' },
    { id: 2, name: 'Go', width: '75%' },
    { id: 3, name: 'Web', width: '50%' },
    { id: 4, name: 'Spring', width: '60%' },
    { id: 5, name: 'Hibernate', width: '50%' }
  ]);
